...
const Hero = () => {
  return (
    ...
    >
      {/* left side */}
      <div
        className="flex-1 text-center lg:text-left lg:ml-8 max-w-2xl 
      z-10"
      >
        ...
        mx-auto lg:mx-0"
        >
          Front-End Developer crafting modern, efficient web interfaces with an
          engineering mindset from Communication Engineering, where performance,
          structure, and precision truly matter.
        </p>
        {/* buttons */}
      ...
      lg:mt-0 w-full overflow-visible"
      >
        <div
          className="scale-[0.8] sm:scale-[0.8] lg:scale-100 
