...
const Hero = () => {
  return (
    <div className="relative w-full h-auto lg:h-screen flex flex-col lg:flex-row items-center justify-center lg:justify-between px-4 pt-20 lg:pt-0 overflow-hidden">
      {/* left side */}
